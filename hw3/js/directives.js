    ...
    return{
       ...
       link: function(scope, elem, attrs){
            ...
            function setChartParameters(){
                ...
                xScale = d3.scaleTime()
                    .domain(d3.extent(dataset, d => d["anio"]))
                ...
                line = d3.line()
                .x(function(d) { return xScale(d.anio); }) // set the x values for the line generator
            ...
            function redrawLineChart() {
                ...
                .attr("cx", function(d) { return xScale(d.anio) })
                ...
                function handleMouseOver(d, i) {  
                    ...
                    svg.append("text")
                        .attr("id", "t" + d.x + "-" + d.y + "-" + i)
                        .attr("x", function() { return xScale(d.anio) - 30; })
                        .attr("y", function() { return yScale(d.count) - 17; })
                        .text(function() {
                            return [d.anio.getFullYear() +" : "+ d.count];  // Value of the text
                        });
                }
